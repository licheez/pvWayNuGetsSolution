# Ms Sql Backup dotNet Core 6

Tiny DAO utility that backs up any Ms Sql Db (any edition) to a local folder, a network 
drive or an Azure Container and executes maintenance plans
